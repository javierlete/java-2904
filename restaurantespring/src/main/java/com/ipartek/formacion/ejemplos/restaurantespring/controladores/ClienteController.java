...
import com.ipartek.formacion.ejemplos.restaurantespring.config.UsuarioLogin;
...
public class ClienteController {
	...
	@GetMapping
	@ResponseBody
	public String cliente(@AuthenticationPrincipal UsuarioLogin usuario) {
		return usuario.toString();
	}

	@PostMapping("pedir")
	public String pedir(Long[] ids, Model modelo, @AuthenticationPrincipal UsuarioLogin usuario) {
